...
use crate::{Dcel, EdgeId, FaceId, HalfEdgeId, VertexId};
...
pub fn assert_vertex_rim(dcel: &Dcel<(i32, i32)>, id: usize, count: usize) {
    let vertex_rim_vertexes: Vec<VertexId> = dcel.vertex_rim_vertexes(VertexId::new(id)).collect();
...
pub fn assert_vertex_spokes_interspokes(dcel: &Dcel<(i32, i32)>, id: usize, count: usize) {
    let vertex_half_spokes: Vec<HalfEdgeId> = dcel.vertex_half_spokes(VertexId::new(id)).collect();
    ...
    let vertex_interspokes: Vec<FaceId> = dcel.vertex_interspokes(VertexId::new(id)).collect();
...
pub fn assert_face_boundary(dcel: &Dcel<(i32, i32)>, id: usize, count: usize) {
